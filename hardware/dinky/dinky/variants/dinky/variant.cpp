 ...
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * +  PIN   |  SAMD21E18A pin  | Label/Name      | Comments (* is for default peripheral in use)
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |        | Digital Low      |                 |
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |  PA11  | 0 -> RX          | RX              | EIC/EXTINT[11] ADC/AIN[19]           PTC/X[3] *SERCOM0/PAD[3]  SERCOM2/PAD[3]  TCC0/WO[3]  TCC1/WO[1]
 * |  PA10  | 1 <- TX          | TX              | EIC/EXTINT[10] ADC/AIN[18]           PTC/X[2] *SERCOM0/PAD[2]                  TCC0/WO[2]  TCC1/WO[0]
 * |  PA00  | 2                |                 | EIC/EXTINT[0]                                    SERCOM4/PAD[2]  TC3/WO[0]   TCC0/WO[4] (32KHz config was EIC/EXTINT[0] SERCOM1/PAD[0] TCC2/WO[0])
 * |  PA09  | ~3               | Green           | EIC/EXTINT[9]  ADC/AIN[17]           PTC/X[1]  SERCOM0/PAD[1]  SERCOM2/PAD[1] *TCC0/WO[1]  TCC1/WO[3]
 * |  PA08  | ~4               | Red             | EIC/NMI        ADC/AIN[16]           PTC/X[0]  SERCOM0/PAD[0]  SERCOM2/PAD[0] *TCC0/WO[0]  TCC1/WO[2]
 * |  PA27  | 5                |                 | EIC/EXTINT[15]
 * |  PA01  | 6                |                 | EIC/EXTINT[1]                                                  SERCOM1/PAD[1] (32KHz config was EIC/EXTINT[1] SERCOM1/PAD[1] TCC2/WO[1])
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |        | Digital High     |                 |
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |  PA18  | ~7               | SS              | EIC/EXTINT[2]                        PTC/X[6] +SERCOM1/PAD[2]  SERCOM3/PAD[2] *TC3/WO[0]    TCC0/WO[2]
 * |  PA16  | ~8               | MOSI            | EIC/EXTINT[0]                        PTC/X[4] +SERCOM1/PAD[0]  SERCOM3/PAD[0] *TCC2/WO[0]   TCC0/WO[6]
 * |  PA19  | ~9               | MISO            | EIC/EXTINT[3]                        PTC/X[7] +SERCOM1/PAD[3]  SERCOM3/PAD[3]  TC3/WO[1]   *TCC0/WO[3]
 * |  PA17  | ~10              | SCK/Blue        | EIC/EXTINT[1]                        PTC/X[5] +SERCOM1/PAD[1]  SERCOM3/PAD[1] *TCC2/WO[1]   TCC0/WO[7]
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |        | Analog Connector |                 |
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |  PA02  | A0/DAC           | A0              | EIC/EXTINT[2] *ADC/AIN[0]  DAC/VOUT  PTC/Y[0]
 * |  PA06  | A1               | A1              | EIC/EXTINT[6] *ADC/AIN[6]            PTC/Y[4]  SERCOM0/PAD[2]                  TC1/WO[0]
 * |  PA07  | A2               | A2              | EIC/EXTINT[9] *ADC/AIN[3]            PTC/Y[5]  SERCOM0/PAD[3]                  TC1/WO[1]
 * |  PA04  | A3               | A3              | EIC/EXTINT[4] *ADC/AIN[4]  AC/AIN[0] PTC/Y[2]  SERCOM0/PAD[0]                  TCC0/WO[0]
 * |  PA05  | A4               | A4              | EIC/EXTINT[5] *ADC/AIN[5]  AC/AIN[1] PTC/Y[3]  SERCOM0/PAD[1]                  TCC0/WO[1]
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |        | Wire             |                 |
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |  PA22  | SDA              | SDA             | EIC/EXTINT[6]                        PTC/X[10] *SERCOM3/PAD[0] SERCOM5/PAD[0] TC4/WO[0] TCC0/WO[4]
 * |  PA23  | SCL              | SCL             | EIC/EXTINT[7]                        PTC/X[11] *SERCOM3/PAD[1] SERCOM5/PAD[1] TC4/WO[1] TCC0/WO[5]
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |        |SPI (Legacy ICSP) |                 |
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |  PA19  | 1                | MISO            | EIC/EXTINT[3] *SERCOM1/PAD[3] SERCOM3/PAD[3] TC3/WO[1]  TCC0/WO[3]
 * |        | 2                | 3V0             |
 * |  PA16  | 4                | MOSI            | EIC/EXTINT[0] *SERCOM1/PAD[0] SERCOM3/PAD[0] TCC2/WO[0] TCC0/WO[6]
 * |  PA18  |                  | SS              | EIC/EXTINT[2] *SERCOM1/PAD[2] SERCOM3/PAD[2] TC3/WO[0]  TCC0/WO[2]
 * |  PA17  | 3                | SCK             | EIC/EXTINT[1] *SERCOM1/PAD[1] SERCOM3/PAD[1] TCC2/WO[1] TCC0/WO[7]
 * |        | 5                | RESET           |
 * |        | 6                | GND             |
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |        | USB              |                 |
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |  PA28  |                  | USB_HOST_ENABLE | EIC/EXTINT[8]
 ...
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |        | GND              |                 |
 * |  PA03  | AREF             | AREF            | EIC/EXTINT[3] *[ADC|DAC]/VREFA ADC/AIN[1] PTC/Y[1]
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |        | SWD              |                 |
 * +--------+------------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |  PA30  |                  | SWDIO           | 
...
const PinDescription g_APinDescription[]=
{
	...
	{ NOT_A_PORT, 0, PIO_NOT_A_PIN, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // NO PA12
	{ NOT_A_PORT, 0, PIO_NOT_A_PIN, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // NO PA13
	{ PORTA, 14, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM3_CH0, TC3_CH0, EXTERNAL_INT_14 }, // TC3/WO[0]
	{ PORTA, 15, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM3_CH1, TC3_CH1, EXTERNAL_INT_15 }, // TC3/WO[1] LED
	
	{ PORTA, 16, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM2_CH0, TCC2_CH0, EXTERNAL_INT_0 }, // TCC2/WO[0] : SPI_MOSI : SERCOM1/PAD[0]
	{ PORTA, 17, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM2_CH1, TCC2_CH1, EXTERNAL_INT_1 }, // TCC2/WO[1] : SPI_SCK : SERCOM1/PAD[1]
	{ PORTA, 18, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM3_CH0, TC3_CH0, EXTERNAL_INT_2 }, // TC3/WO[0] : SPI_SS : SERCOM1/PAD[2]
	{ PORTA, 19, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), No_ADC_Channel, PWM0_CH3, TCC0_CH3, EXTERNAL_INT_3 }, // TCC0/WO[3] : SPI_MISO : SERCOM1/PAD[3]
	{ NOT_A_PORT, 0, PIO_NOT_A_PIN, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // NO PA20
	{ NOT_A_PORT, 0, PIO_NOT_A_PIN, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // NO PA21
	{ PORTA, 22, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6 }, // I2C_SDA : SERCOM3/PAD[0]
	{ PORTA, 23, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 }, // I2C_SCL : SERCOM3/PAD[1]
	{ PORTA, 24, PIO_COM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // USB/DM
	{ PORTA, 25, PIO_COM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // USB/DP
	{ NOT_A_PORT, 0, PIO_NOT_A_PIN, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // NO PA26
	{ PORTA, 27, PIO_DIGITAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_15 },
	{ PORTA, 28, PIO_COM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // USB Host enable
	{ NOT_A_PORT, 0, PIO_NOT_A_PIN, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // NO PA29
